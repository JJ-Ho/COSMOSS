...
for Na=1:N
    for Nb=1:N
            ...
            R1(ISave,4:end)  = kron(kron(kron(A_b0(:),M_0b(:)),M_a0(:)),M_0a(:));
            R2(ISave,4:end)  = kron(kron(kron(A_b0(:),M_0a(:)),M_b0(:)),M_0a(:));
            
            NR1(ISave,4:end) = kron(kron(kron(A_b0(:),M_0b(:)),M_a0(:)),M_0a(:));
            NR2(ISave,4:end) = kron(kron(kron(A_a0(:),M_0b(:)),M_b0(:)),M_0a(:));
        ...
        for Nx=1:N*(N+1)/2
            ...
            R3(ISave,4:end)  = kron(kron(kron(A_ax(:),M_xb(:)),M_b0(:)),M_0a(:));
            NR3(ISave,4:end) = kron(kron(kron(A_bx(:),M_xa(:)),M_b0(:)),M_0a(:));
