...
uicontrol( 'Parent', ButtonBox, ...
    ...
    'Style', 'PushButton', ...
    'String', 'AR SFG',...
    'Callback', @(hObject,eventdata)COSMOSS('AR_SFG_Callback',hObject,eventdata,guidata(hObject))); 
uicontrol( 'Parent', ButtonBox, ...
    'Style', 'PushButton', ...
...
set(CSPanelLayout,'Heights',[75,-1])
...
DDPanelLayout = uix.VBox('Parent',DisorderPanel,...
    ...
    NSampleHBox = uix.HBox('Parent',DDPanelLayout,...
        ...
        uicontrol('Parent',NSampleHBox,...
                  ...
                  'units', 'normalized',...
                  'fontunits', 'point', 'fontsize', 14);
    set(NSampleHBox,'Widths',[120,80,-1])
...
set(DDPanelLayout,'Heights',[-1,-1,-1,-1])
...
FPanelLayout = uix.VBox('Parent',FigurePanel,...
    ...
    CheckBoxRaw1 = uix.HBox('Parent',FPanelLayout,...
        ...
        uicontrol('Parent',CheckBoxRaw1,...
                  ...
                  'Value',0,...
                  'units', 'normalized',...
                  'Callback', @(hObject,eventdata)COSMOSS('Toggle_Fig_Save_Callback',hObject,eventdata,guidata(hObject)),...
                  'fontunits', 'point', 'fontsize', 14);
        uicontrol('Parent',CheckBoxRaw1,...
                  'Style','edit',...
                  'String','~/Desktop/TMP',...
    ...
    CheckBoxRaw2 = uix.HBox('Parent',FPanelLayout,...
        ...
        uicontrol('Parent',CheckBoxRaw2,...
                  ...
                  'Value',0,...
                  'units', 'normalized',...
                  'Callback', @(hObject,eventdata)COSMOSS('Toggle_Fig_DataCursor_Callback',hObject,eventdata,guidata(hObject)),...
                  'fontunits', 'point', 'fontsize', 14);
    ...
    LineshapeHBox = uix.HBox('Parent',FPanelLayout,...
        ...
        uicontrol('Parent',LineshapeHBox,...
          ...
          uicontrol('Parent',LineshapeHBox,...
                  ...
                  'units', 'normalized',...
                  'fontunits', 'point', 'fontsize', 14);
    set(LineshapeHBox,'Widths',[70,80,50,-1,40])    
    %% Contour Box                                                  
...
TwoDIR_TabLayout = uix.VBox('Parent',TwoDIR_Tab,...
    ...
    HCut_2DIR_HBox = uix.HBox('Parent',TwoDIR_TabLayout,...
        ...
        uicontrol( 'Parent', HCut_2DIR_HBox, ...
            ...
            'fontunits', 'point', 'fontsize', 14,...
            'Callback', @(hObject,eventdata)COSMOSS('HCut_Callback',hObject,eventdata,guidata(hObject)));
        uicontrol('Parent',HCut_2DIR_HBox,...
                    'Style','edit',...
                    'String','0',...
                    'HorizontalAlignment','right',...
    ...
    DiagCut_2DIR_HBox = uix.HBox('Parent',TwoDIR_TabLayout,...
        ...
        uicontrol( 'Parent', DiagCut_2DIR_HBox, ...
            ...
            'String', 'Diagonal cut',...
            'fontunits', 'point', 'fontsize', 14,...
            'Callback', @(hObject,eventdata)COSMOSS('DiagCut_Callback',hObject,eventdata,guidata(hObject)));
        uix.Empty('Parent',DiagCut_2DIR_HBox);
    set(DiagCut_2DIR_HBox,'Widths',[130,-1])   

    uix.Empty('Parent',TwoDIR_TabLayout);
set(TwoDIR_TabLayout,'Heights',[30,30,-1])
...
set(TwoDSFG_TabLayout,'Heights',[30,30,-1])
...
hL_Str = addlistener(SA,'String','PostSet',@(SA,eventdata)COSMOSS('UpdateCalculation',SA,eventdata,guidata(hCOSMOSS)));
hL_Val = addlistener(SA, 'Value','PostSet',@(SA,eventdata)COSMOSS('UpdateCalculation',SA,eventdata,guidata(hCOSMOSS)));
