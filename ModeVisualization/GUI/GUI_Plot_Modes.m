...
set(MainLayout,'Heights',[-1,165,60,30])

%% ModeListPanel
CF = TableFormat('SFG'); % call TableFormat to build SFG default table 
...
hT = uitable('Parent', ModeListLayout, ...
             'Data', [],...
             'ColumnName',CF.Name,...
             'ColumnFormat',CF.Format,...
             'ColumnWidth',CF.Width,...
             'tag','ModeList',...
...
PlotPanelLayout = uix.VBox('Parent',TDV_Raman_Panel,...
    ...
    Raman_ModeScaleBox = uix.HBox('Parent',PlotPanelLayout,...
        ...
        uicontrol('Parent',Raman_ModeScaleBox,...
                  ...
                  'units', 'normalized',...
                  'fontunits', 'point', 'fontsize', 14);
    set(Raman_ModeScaleBox,'Widths',[200,60,60,-1,90,200])    
    ...
    set(EigenVecBox,'Widths',[300,50,-1,100,200])
