...
LBox = uix.VBoxFlex(...
    ...
    StructurePanel = uix.BoxPanel( ...
        'Parent',LBox,...
        'Title','Select a structure model:','FontSize', FS);

    BeamGeometryPanel = uix.BoxPanel( ...
        'Parent',LBox,...
        'Title','Experimental Geometry','FontSize', FS);

    SamplePanel = uix.BoxPanel( ...
        'Parent',LBox,...
        'Title','Sample symmetry','FontSize', FS);
    
    LaserPanel = uix.BoxPanel( ...
        'Parent',LBox,...
        'Title','LASER setting','FontSize', FS);
...
RBox = uix.VBoxFlex(...
    ...
    DisorderPanel = uix.BoxPanel( ...
        'Parent',RBox,...
        'Title','Diagonal Disorder','FontSize', FS);

    ModelPanel = uix.BoxPanel( ...
        'Parent',RBox,...
        'Title','Coupling/Signal','FontSize', FS);

    FigurePanel = uix.BoxPanel( ...
        'Parent',RBox,...
        'Title','Figure Setting','FontSize', FS);
...
SamplePanelLayout = uix.VBox('Parent',SamplePanel,...
    'Padding', 1, 'Spacing', 1,'Visible','off');
...
%% Laser Setting Panel
LaserTabGP = uitabgroup('Parent',LaserPanel,'Visible','off');
