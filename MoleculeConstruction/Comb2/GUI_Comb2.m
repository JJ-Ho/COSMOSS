...
%% Define avalible list
StructureModelList = {'Two Coupled Oscillators',...
                      'PDB_AmideI',...
                      '2D Grid',...
                      'Ideal Betasheet'};
