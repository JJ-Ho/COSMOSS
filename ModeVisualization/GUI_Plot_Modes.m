...
set(MainLayout,'Heights',[-1,120,25,25])

%% ModeListPanel
ModeList = [0,0,0];
cnames  = {'Index','Freq.','Sig Norm','Mu Int','Tr[A]' ,'Sig ZZZ','Mu z','A zz'};
cformat = {'short', 'bank',    'bank',  'bank',  'bank',   'bank','bank','bank'};
cwidth  = {     40,     50,        60,      50,      50,       50,    50,    50};
...
uicontrol('Parent',PlotPanelLayout,...
          'Style','checkbox',...
          'String','Normalize modes for direaction comparison,',...
          'Value',1,...
          'Tag','Normalize',...
          'HorizontalAlignment','left',...
          'units', 'normalized',...
...
set(PlotPanelLayout,'Heights',[-1,-1,-1,-1])
