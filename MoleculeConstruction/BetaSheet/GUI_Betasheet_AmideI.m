...
MainLayout = uix.VBoxFlex(...
    ...
    SheetPanel = uix.BoxPanel( ...
        'Parent',MainLayout,...
        'Title','Betasheet parmeters','FontSize', FS);

    OrientationPanel = uix.BoxPanel( ...
        'Parent',MainLayout,...
        'Title','Molecule Orientation','FontSize', FS);

    LabelPanel = uix.BoxPanel( ...
        'Parent',MainLayout,...
        'Title','Local Mode Frequency','FontSize', FS);

    FigurePanel = uix.BoxPanel( ...
        'Parent',MainLayout,...
        'Title','Molecule figure options','FontSize', FS);
...
FigurePanelLayout = uix.HBox('Parent',FigurePanel,...
    ...
    set(FigurePanelLayout,'Widths',[65,60,60,-1])
